...
2.  **Build Hooks**: Executes any custom scripts found in `/build-hooks.d/`. This is the ideal place to add new APT repositories or perform layer-specific setup _before_ packages are installed.
