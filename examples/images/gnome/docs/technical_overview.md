...
## 3. Antigravity Tooling Layer (AI & Advanced Tools)
The Antigravity layer extends the workstation with enterprise-grade development tools and AI-driven workflows.
...
*   **Key Features:**
    ...
    *   **Skill Modular System:** Contains specific skills (e.g., `troubleshoot-cws`, `enforce-standards`, `persona-swe`) that guide AI behavior safely inside the workspace.
