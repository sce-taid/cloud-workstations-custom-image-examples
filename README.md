...
This project adheres to strict Google Engineering practices to ensure reliability, security, and maintainability.

- 👉 **[Product Requirements](docs/requirements.md)**: Objective, success criteria, and SLOs.
- 👉 **[Test Plan](docs/test_plan.md)**: Verification strategy for requirements and SLOs.
- 👉 **[Style Guides](docs/style_guides/)**: Mandatory standards for Bash, Terraform, Go, and more.
- 👉 **[AI Agent Instructions](AGENTS.md)**: Global mandates for AI-driven development.
