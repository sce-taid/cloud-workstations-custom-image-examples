...
module "cicd_foundation" {
  ...
  cws_custom_images = {
    "gnome" = {
      ...
      build = {
        skaffold_path = "examples/images/gnome/"
        env = {
          CWS_BASE_IMAGE_TAG = "latest"
          GCP_REGION         = "us-central1"
          PREFLIGHT_WEB_REPO = "https://github.com/sce-taid/cloud-workstations-custom-image-examples.git"
          PREFLIGHT_WEB_DIR  = "examples/preflight-web"
        }
      }
    }
  }
