...
- **Language Standards**: Adhere strictly to the repository's language style guides, especially for high-performance automation scripts (see the [Go Style Guide](../../docs/style_guides/go.md)).
