...
// Package i18n provides internationalization and localization support for GitSeep.
package i18n
...
// It loads all JSON files from the provided filesystem.
func Init(lang, defaultLang string, localesFS fs.FS) error {
	...
	// Priority: 1. Passed lang, 2. $LANG env var, 3. Default
	if lang == "" {
		lang = os.Getenv("LANG")
	}
...
// T translates a simple string by its ID.
