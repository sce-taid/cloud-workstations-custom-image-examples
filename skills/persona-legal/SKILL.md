...
- **Copyright Management**: Maintain up-to-date copyright headers in all source files.
...
## Tooling
- **`skills/enforce-standards/scripts/sync_license_assets.sh`**: This script reads the `examples/preflight/web/public/sbom.json` file and automatically fetches the full license text for each component from the URL specified in the SBOM.
